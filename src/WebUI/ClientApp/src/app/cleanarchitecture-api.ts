...
export interface ICommentsClient {
    get(newsId: string | undefined): Observable<CommentsVm>;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CommentsVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<CommentsVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CommentsVm> {
        ...
        return _observableOf<CommentsVm>(<any>null);
    }
...
export interface INewsClient {
    get(): Observable<NewsVm>;
    create(command: CreateNewsItemCommand): Observable<number>;
    update(id: number, command: UpdateNewsItemCommand): Observable<FileResponse>;
...
export class NewsClient implements INewsClient {
    ...
    protected processGet(response: HttpResponseBase): Observable<NewsVm> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (_data) {
            if (Array.isArray(_data["list"])) {
                ...
                for (let item of _data["list"])
                    this.list!.push(CommentDto.fromJS(item));
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["list"])) {
                this.list = [] as any;
                for (let item of _data["list"])
                    this.list!.push(NewsItemDto.fromJS(item));
            }
        }
    }
...
export class CreateNewsItemCommand implements ICreateNewsItemCommand {
    title?: string | undefined;
    description?: string | undefined;

    constructor(data?: ICreateNewsItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateNewsItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateNewsItemCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateNewsItemCommand {
    title?: string | undefined;
    description?: string | undefined;
}

export class UpdateNewsItemCommand implements IUpdateNewsItemCommand {
    id?: number;
    title?: string | undefined;
    description?: string | undefined;

    constructor(data?: IUpdateNewsItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateNewsItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateNewsItemCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateNewsItemCommand {
    id?: number;
    title?: string | undefined;
    description?: string | undefined;
}
